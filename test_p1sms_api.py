#!/usr/bin/env python3
"""
Тестовый скрипт для проверки P1SMS API
"""
...
from accounts.p1sms_service import P1SMSService


def test_p1sms_service():
    """Тестирует сервис P1SMS"""
    print("🧪 Тестирование P1SMS Service...")
    print("=" * 50)
    
    # Создаем экземпляр сервиса
    service = P1SMSService()
